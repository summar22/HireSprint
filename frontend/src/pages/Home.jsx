        ...
        <div className='bg-white text-[#0A0A0A] font-sans min-h-screen overflow-x-hidden'>
            ...
            <motion.nav
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <span className='font-extrabold text-base tracking-tight text-[#0A0A0A]'>HireSprint</span>
                </div>
            ...
            <section className='relative pt-20 pb-14 overflow-hidden bg-[#F8F9FA]'>
                ...
                <div className='max-w-4xl mx-auto px-6 text-center'>
                    ...
                    <motion.p
                        ...
                        HireSprint is an innovative AI-powered interview preparation platform
                ...
                <div className='max-w-5xl mx-auto px-6'>
                    <div className='text-center mb-10'>
                        ...
                        <p className='text-black/40 text-sm max-w-2xl mx-auto mt-4 leading-relaxed'>
                            HireSprint combines multiple AI agents that work together
            ...
            {showLogin && <LoginModel onClose={() => setShowLogin(false)} setUser={setUser} />}
                ...
                <div className='flex items-center justify-center gap-2 mb-1.5'>
                    ...
                    <span className='font-bold text-xs text-[#0A0A0A]/70'>HireSprint</span>
                </div>
